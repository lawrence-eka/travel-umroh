yalla.framework.addComponent("/dist/itinerary/list", (function() {
  var $patchChanges = yalla.framework.renderToScreen;
  var $inject = yalla.framework.createInjector("/dist/itinerary/list");
  var $export = {};
  var $path = "/dist/itinerary/list";
  var _elementName = "dist.itinerary.list";
  var _context = {};
  ...
  function $render(_props, _slotView) {
    ...
    _attr("element", "dist.itinerary.list");
    _elementOpenEnd("div");

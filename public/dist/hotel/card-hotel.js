yalla.framework.addComponent("/dist/hotel/card-hotel", (function() {
  var $patchChanges = yalla.framework.renderToScreen;
  var $inject = yalla.framework.createInjector("/dist/hotel/card-hotel");
  var $export = {};
  var $path = "/dist/hotel/card-hotel";
  var _elementName = "dist.hotel.card-hotel";
  var _context = {};
  ...
  function $render(_props, _slotView) {
    ...
    _attr("element", "dist.hotel.card-hotel");
    _elementOpenEnd("div");
    ...
    (function(domNode) {
      ...
      var promise = getHotel.bind(self)(_props.hotel);

yalla.framework.addComponent("/dist/itinerary/card-itinerary-bulleted", (function() {
  ...
  function $render(_props, _slotView) {
    ...
    if (_props.itr.entry.transport) {
      ...
      _elementClose("label");
      _elementClose("h5");
      _text("" + (_props.itr.entry.transportType) + ":" + (nbsp) + "" + (_props.itr.entry.transport) + "");
      _elementOpenStart("br", "");
      _elementOpenEnd("br");
      _elementClose("br");
      _text("From:" + (nbsp) + "" + (_props.itr.entry.departFrom) + "");
      _elementOpenStart("br", "");
      _elementOpenEnd("br");
      _elementClose("br");
      _text("To:" + (nbsp) + "" + (_props.itr.entry.arriveAt) + "");
      _elementOpenStart("br", "");
      _elementOpenEnd("br");
      _elementClose("br");
      _elementClose("div");
    ...
    if (_props.itr.entry.hotel) {
      ...
      _elementClose("label");
      _elementClose("h5");
      _text("Hotel:" + (nbsp) + "" + (_props.itr.entry.hotel) + "");
      _elementOpenStart("br", "");
      _elementOpenEnd("br");
      _elementClose("br");
      _text("City:" + (nbsp) + "" + (_props.itr.entry.city) + "");
      _elementOpenStart("br", "");
      _elementOpenEnd("br");
      _elementClose("br");
      _elementClose("div");

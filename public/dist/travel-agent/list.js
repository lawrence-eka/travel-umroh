yalla.framework.addComponent("/dist/travel-agent/list", (function() {
  ...
  var $inject = yalla.framework.createInjector("/dist/travel-agent/list");
  var $export = {};
  var $path = "/dist/travel-agent/list";
  var _elementName = "dist.travel-agent.list";
  var _context = {};
  ...
  function $render(_props, _slotView) {
    ...
    _attr("element", "dist.travel-agent.list");
    _elementOpenEnd("div");

yalla.framework.addComponent("/dist/prayers/prayer-name", (function() {
  var $patchChanges = yalla.framework.renderToScreen;
  var $inject = yalla.framework.createInjector("/dist/prayers/prayer-name");
  var $export = {};
  var $path = "/dist/prayers/prayer-name";
  var _elementName = "dist.prayers.prayer-name";
  var _context = {};
  ...
  function onExpand() {
    ...
    this.emitEvent('expand', {
      isExpand: this.state.class == "fa fa-minus-square-o",
  ...
  function $render(_props, _slotView) {
    ...
    _attr("element", "dist.prayers.prayer-name");
